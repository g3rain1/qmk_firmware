...
[_BL] = KEYMAP_HHKB(
  ...
  KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,                                                KC_RALT, MO(_FL), KC_RCTL, KC_PGDN),
...
[_FL] = KEYMAP_HHKB(
  ...
  _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, LOCK, _______, _______,           _______, \
