...
{LT(_FL,KC_F2),KC_A, KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT},
  ...
  {KC_LCTL,KC_LGUI ,KC_LALT,KC_LBRC,KC_RBRC,KC_SPC,TD(DANCE_LAYERS),KC_MINS,KC_EQL,KC_QUOT,KC_ESC,KC_DEL}
},

[_FL] = {
  {KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,     KC_F8,   KC_F9,   KC_F10, KC_DEL},
  {_4SPACE, _______, KC_UP, _______, _______, _______,   _______,  _______,   KC_PSCR, KC_SLCK, KC_PAUS, _______},
