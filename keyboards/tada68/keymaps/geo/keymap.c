...
[_FL] = KEYMAP_ANSI(
  ...
  _4SPACE,_______,KC_UP, _______,_______,_______,_______,_______,_______,_______,KC_PSCR, KC_SLCK,KC_PAUS, _______,KC_INS, \
  _______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,_______,_______,_______,LOCK,_______,KC_PGUP, _______,      KC_HOME, \
  _______,_______,_______,BL_DEC, BL_TOGG,BL_INC, _______,_______,KC_HOME,KC_END,KC_PGDN,_______,_______,         KC_END, \
